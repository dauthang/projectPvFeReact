...
class DailyExpensePopupImport extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            open: false,
    ...
    onFileUpload() {
        axios({
            url: `http://localhost:8080/import/importDailyExpense`,
            method: 'post',
    ...
    onDownload() {
        axios({
            url: `http://localhost:8080/download/templateDailyExpense`,
            method: 'get',
            responseType: 'blob'
        }).then((response) => {
            ...
            link.setAttribute('download', "DailyExpense_" + this.converDate() + ".xlsx"); //any other extension
...
export default DailyExpensePopupImport;